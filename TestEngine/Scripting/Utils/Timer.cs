...
namespace TestEngine.Utils
{
    ...
    public class Timer
    {
        ...
        public static Timer Register(float duration, Action onComplete, Action<float> onUpdate = null,
            bool isLooped = false, bool useRealTime = false, Behaviour autoDestroyOwner = null)
        {
            ...
            if (Timer._manager == null)
            {
                ...
                TimerManager managerInScene = Engine.FindBehaviour<TimerManager>(); // want to do this without a reference
                ...
                else
                {
                    ...
                    Timer._manager = managerObject.AddComponent<TimerManager>(); // want to add a class that's derived from Behaviour, of which is derived from Component
                }
            }
        ...
        private readonly Behaviour _autoDestroyOwner;
        ...
        private Timer(float duration, Action onComplete, Action<float> onUpdate,
            bool isLooped, bool usesRealTime, Behaviour autoDestroyOwner)
        {
        ...
        /// scene manually.
        /// </summary>
        private class TimerManager : Behaviour
        {
